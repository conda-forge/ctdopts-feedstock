...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ctdopts-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8871&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ctdopts-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ctdopts` can be installed with:

```
conda install ctdopts
```

It is possible to list all of the versions of `ctdopts` available on your platform with:
